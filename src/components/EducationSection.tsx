          ...
          >
            ...
            <div className="relative flex flex-col gap-2">
              ...
              <div className="pt-2 flex flex-col gap-4">
                {edu.currentCoursework && edu.currentCoursework.length > 0 && (
                  <div>
                    <p className="text-sm font-semibold mb-2">Current Coursework</p>
                    <div className="flex flex-wrap gap-2">
                      {edu.currentCoursework.map((course, idx) => (
                        <span
                          key={idx}
                          className="px-2 py-1 text-xs font-mono bg-black/5 dark:bg-white/10 rounded-md text-[var(--text-muted)] border border-blue-500/20 dark:border-blue-400/20"
                        >
                          {course}
                        </span>
                      ))}
                ...
                {edu.completedCoursework && edu.completedCoursework.length > 0 && (
                  <div>
                    <p className="text-sm font-semibold mb-2">Completed Coursework</p>
                    <div className="flex flex-wrap gap-2">
                      {edu.completedCoursework.map((course, idx) => (
                        <span
                          key={idx}
                          className="px-2 py-1 text-xs font-mono bg-black/5 dark:bg-white/10 rounded-md text-[var(--text-muted)] border border-green-500/20 dark:border-green-400/20"
                        >
                          {course}
                        </span>
                      ))}
